            ...
            items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xstext-app-text-light">
                    {currency}
        ...
        {items.length > 0 && (
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">
                {deliveryFee === 0 ? (
                  <span className="texta-pp-success">Free</span>
                ) : (
            ...
            {deliveryFee > 0 && (
              <p className="flex justify-between text-base font-semibold border-t border-app-border pt-3">
